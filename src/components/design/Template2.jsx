...
const Template2 = () => {
  ...
  const generatePDF = async () => {
    const element = resumeRef.current;
    if(!element) {
      toast.error("Unable to capture the content at a moment");
      return
    }
        ...
        <div className="col-span-12  px-4 py-6">
          ...
          <div className="w-full h-auto grid grid-cols-12" ref={resumeRef}>
            <div className="col-span-4 bg-black flex flex-col items-center justify-start">
              ...
              <div className="w-full flex flex-col items-start justify-start bg-slate-500 py-6 h-full mt-6 gap-6">
            ...
            <div className="col-span-8 flex flex-col items-center justify-start  bg-white">
              ...
              {/* title */}
              <div className="w-full px-8 py-16 bg-gray-300">
                ...
                <input
                  ...
                  type="text"
                   readOnly={true}
                  className={`bg-yellow-500 outline-none border-none text-xl tracking-widest uppercase text-txtPrimary rounded-md px-2 ${
                    isEdit && "text-white"
                  }`}
                />
                 <div className="w-full mt-4">
                  <p className="uppercase text-2xl font-semibold tracking-wider">Profile</p>
                  <div className="w-full h-1 bg-txtDark my-2"></div>
                  <textarea
                     readOnly={true}
                          ...
                          >
                            <div className="col-span-4">
                              <input
                                ...
                                type="text"
                                 readOnly={true}
                                className={`outline-none border-none w text-base tracking-eide uppercase text-black ${
                                  isEdit ? "bg-gray-200" : "bg-transparent"
                                }`}
                              />
                            </div>
